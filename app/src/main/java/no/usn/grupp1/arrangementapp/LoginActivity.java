...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView = (EditText) findViewById(R.id.password_signin);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            // TODO: skal utføre sjekk av brukerkonto opp mott database
            ...
            if (isOnline()){
                ...
                JsonObjectRequest JSONRequest = new JsonObjectRequest(Request.Method.GET, username, null, new Response.Listener<JSONObject>() {
                    @Override
